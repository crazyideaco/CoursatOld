...
<style>
  ...
  <strong>Success!</strong>{{session()->get('success')}}
                      ...
                      @endif
                     <form method="post" action="{{route('storeyourinformation')}}" enctype="multipart/form-data">
                        	@csrf
                            ...
                            <div class="col-lg-3 col-md-6 col-12 text-center set-img">
                               ...
                               <img src="{{asset('uploads/'.$user->image)}}" id="realimg">
                    ...
                    <br>
                               <input id="ad" type="file" class="form-control ehabtalaat"  name="image">
                                ...
                                <img src="{{asset('uploads/'.$user->cover_image)}}" id="realimg3">
                    <br>
                               ...
                               <img src="{{asset('uploads/'.$user->printsplash)}}" id="realimg2">
              ...
              <source src="{{asset('uploads/'.$user->intro)}}" id="video_here">
                   ...
                   <input id="kt" type="file" class="form-control ehabtalaat" name="intro">
                      ...
                      <select name="state_id" class="form-control" onchange="getcity(this)">
                          ...
                          <option value="{{$state->id}}" @if(auth()->user()->state_id == $state->id)
							  selected @endif>{{$state->state}}</option>
                          @endforeach
                          </select>
                          </div>
                             <div class="form-group col-md-4 col-12">

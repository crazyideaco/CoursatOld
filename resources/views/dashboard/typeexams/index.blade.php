                        ...
                        <div class="products-search typs1">
                            <div class="row">
                                <div class="col-lg-3 col-12">
                                  ...
                                  <a href="{{route('addtypeexam',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة امتحان  
                                        </a>
                                    </button>
                              </div>
                    ...
                    <td  class="text-center">
                      ...
                      <td class="text-center">{{$exam->date_day}} </td>
                        <td class="text-center">
                                ...
                                <a href="{{route('edittypeexam',$exam->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 
                         style="cursor: pointer"></a>
                      
                           <img src="{{asset('images/trash.svg')}}" id="trash" onclick="deletegroup('{{$exam->id}}')" style="cursor:pointer;"> 
               <a href="{{route('typeexamresults',$exam->id)}}" class="btn btn-success btn-sm mt-3" >نتائج الامتحان</a>
                                            </td>
                                        </tr>                            
                                        @endforeach
                                    </tbody>

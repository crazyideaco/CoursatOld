        ...
        <div class="container">
            ...
            <div class="setting">
                <div class="container">
                    ...
                    <form method="post" action="{{ route('updatetypeexam', $exam->id) }}" enctype="multipart/form-data">
                        @csrf
                        <section id="section">
                            <div class="info">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-4 col-6 my-2">
                                        <span class="btn btn-success text-white w-100" id="click">
                                            اضافه سؤال
                                        </span>
                                    </div>
                                    <div class="col-lg-4 col-6 my-2">
                                        <span class="btn btn-primary text-white w-100" onclick="addquestion()">
                                            بنك الاسئله العام
                                        </span>
                                    </div>
                                    <div class="col-lg-4 col-6 my-2">
                                        <span class="btn btn-danger text-white w-100 pl-3" onclick="addquestion3()">
                                            بنك الاسئله الخاص
                                        </span>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-12 text-center">
                                                @if ($question->question_image)
                                                    <img src="{{ asset('uploads/' . $question->question_image) }}"
                                                        id="r{{ $key }}"
                                                        style="width:200px;height:200px;margin:2% 0">
                                                @else
                                                    <img src="{{ asset('images/set-img.svg') }}" id="r{{ $key }}"
                                                        style="width:200px;height:200px;margin:2% 0">
                                                @endif
                                                <br>
                                                <input id="d{{ $key }}" type="file"
                                                    class="form-control ehabtalaat"
                                                    value="{{ $question->question_image }}"
                                                    onchange="getimage({{ $key }})"
                                                    name="question_image[{{ $key }}]"
                                                    style="width:50px;height:50px;">
                                                <input type="hidden" value="{{ $question->question_image }}"
                                                    name="question_image[{{ $key }}]">
                                                <label for="d{{ $key }}" class="ahmed">اضافة صوره</label>
                                        ...
                                        @foreach ($question->answers as $key1 => $answer)
                                            <div class="row rowanswers">
                                                ...
                                                <div class="col-lg-1 col-4">
                                                    ...
                                                    <input type="checkbox" class="hello{{ $key }}"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <img src="{{ asset('remove.png') }}"
                                                    style="width:40px;height:40px;cursor:pointer;" class="mt-4"
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    $('#success').html('<span class="text-success"><b>' + data.success +
                        '</b></span><br /><br />');
                    location.href = `../typeexams/${data.id}`;
                }
            }
        });
     ...
     <div id="s${id}"><div class="info">
                            ...
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[${id}]">
                                   ...
                                   <div class="col-12 text-center">
                               <img src="{{ asset('images/set-img.svg') }}" id="r${id}" style="width:200px;height:200px;margin: 2% 0">
                    <br>

                ...
                <div class="setting">
                    <div class="container">
                      ...
                      <select name="user_id" class="form-control selectpicker" id="user_id" data-live-search="true" required >
                          ...
                          <option value="{{$general->id}}"  @if($p->user_id == $general->id) selected @endif>{{$general->name}}</option>
                          @endforeach
                      </select>
                           </div>
                      ...
                      <select name="paqa_id"  id="paqa_id" class="form-control selectpicker"  data-live-search="true" required >
                          ...
                          <option value="{{$general->id}}" @if($p->paqa_id == $general->id) selected @endif>{{$general->name}}</option>
                          @endforeach
                      </select>
                           </div>
                        ...
                        <div class="save text-center mt-6">
                            <div class="row save">
                                <div class="col-12 text-center">
                                  <input type="button" onclick="storepaqasuser({{$p->id}})" value="حفظ" class="text-center">
...
function storepaqasuser(id){
 $.ajaxSetup({
  ...
  position: 'top-end',
  icon: 'success',
  title: 'تم  تعديل الباقه للمستخدم',

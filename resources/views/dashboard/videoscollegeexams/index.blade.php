                    ...
                    <div class="container">
                        ...
                        <div class="products-search typs1">
                            <div class="row">
                                <div class="col-3">
                                    <button class="btn" >
                                  <a href="{{route('addvideoscollegeexam',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة امتحان  
                                        </a>
                                    </button>
                              </div>
   ...
   <thead>
          ...
          <tbody>
                    ...
                    <tr id="exam{{$exam->id}}">
                      ...
                      <td class="text-center">{{$exam->videoscollege->name_ar}} </td>
                   ...
                   {{$exam->typescollege->name_ar}}</td>
                      ...
                      <td class="text-center">{{$exam->date_day}} </td>
                        <td class="text-center">
                                ...
                                <a href="{{route('editvideoscollegeexam',$exam->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 

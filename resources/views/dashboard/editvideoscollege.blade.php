                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                          ...
                          <form method="post" action="{{route('updatevideoscollege',$video->id)}}" enctype="multipart/form-data">
                        	@csrf
                            ...
                            <div class="row">
                               ...
                               placeholder="الاسم">
                                 ...
                                 <div class="form-group col-3">
                                   ...
                                   <input id="pay" style="width: 13px;" type="checkbox"  value="1" name="pay" @if($video->paid == 1) checked @endif >

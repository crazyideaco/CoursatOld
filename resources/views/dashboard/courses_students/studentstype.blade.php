   ...
   <thead>
        ...
        <tbody>
			 ...
			 <td class="text-center">
                               <span class="btn  btn-sm"style="border:1px solid #222; margin-bottom:10px; padding:6px 45px" id="btn{{$student->id}}" onclick="deletestudentcourse({{$student->id}},{{$id}})">
                         حذف
                         </span>
                 <?php if($status == 0){
...
?>
                    ...
                    <span class="btn  btn-sm"style="border:1px solid #222; margin-bottom:10px; padding:6px 45px" id="btning{{$student->id}}" onclick="activestudentcourse({{$student->id}},{{$id}})">

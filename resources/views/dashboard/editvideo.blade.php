                   ...
                   <input id="ad" type="file" class="form-control ehabtalaat" name="image">
                        ...
                        <div class="info">
                            ...
                            <div class="row">
                                  ...
                                  <input id="name_ar" type="text" class="form-control" required name="name_ar" value="{{$video->name_ar}}"
                               placeholder="عنوان الفيديو بالعربى ">
                               </div>  <div class="form-group col-4">
                                  <input id="name_en" type="text" class="form-control" required name="name_en" value="{{$video->name_en}}"
                           ...
                           <div class="form-group col-4">
                              ...
                              <div class="form-group col-3">
                               ...
                               <input style="height: 36px;" min="0" type="number" value="{{$video->order_number}}" name="order_number">
                               </div>
                            </div>

...
@section('content')
   ...
   <thead>
          ...
          <tbody>
                    @foreach($subtypeexam->students as $student)
                    <tr id="exam{{$student->id}}">
                  <td>{{$student->id}}</td>
                      ...
                      {{$student->name}}
						  ...
						  <td class="text-center">{{$student->code}} </td>
                           ...
                           <td class="text-center">{{$student->pivot->exam_score}} </td>
                    
                     <td class="text-center">{{$student->pivot->student_score}} </td>        
                               <td class="text-center">{{\Carbon\Carbon::parse($student->pivot->created_at)->format('Y-m-d')}} </td>   
                                        </tr>                            
                                        @endforeach
                                    </tbody>
                                    </table>

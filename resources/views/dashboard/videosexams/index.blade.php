                    ...
                    <div class="container">
                        ...
                        <div class="products-search typs1">
                            <div class="row">
                                <div class="col-3">
                                    <button class="btn" >
                                  <a href="{{route('addvideoexam',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة كويز  
                                        </a>
                                    </button>
                              </div>
                    ...
                    <tr id="exam{{$exam->id}}">
                      ...
                      <td class="text-center">{{$exam->date_day}} </td>
                        <td class="text-center">
                                ...
                                <a href="{{route('editvideoexam',$exam->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 

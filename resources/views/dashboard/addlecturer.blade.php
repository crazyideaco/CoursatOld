               ...
               <!--start heed-->
                ...
                <div class="setting">
                    <div class="container">
                     ...
                     <form method="post" action="{{route('storelecturer')}}" enctype="multipart/form-data">
                        	@csrf
          ...
          <br>
                   <input id="kt" type="file" class="form-control ehabtalaat" name="intro">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                 ...
                                 @enderror
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الهاتف</label>
                                    <input class="form-control" type="number" min="0" name="phone" value="{{old('phone')}}">
                                     @error('phone')
                                 <p style="color:red;">{{$message}}</p>
                                 @enderror
                                </div>
                      ...
                      <select name="general_id" class="form-control" onchange="getsub(this)">
                          ...
                          <option value="{{$general->id}}" @if(old('general_id') == $general->id) selected @endif>{{$general->name_ar}}</option>
                          @endforeach
                      </select>
                             @error('general_id')
                                 <p style="color:red;">{{$message}}</p>
   ...
   $('form').ajaxForm({
      ...
      success:function(data)
      {
        if(data.errors)
        {
          ...
          $('#success').html('<div class="text-danger" ><div>'+data.errors+'</div></div>');
        }
        if(data.success)
        {

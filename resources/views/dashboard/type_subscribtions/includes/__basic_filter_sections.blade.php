...
<div class="form-group col-lg-2 col-md-6 col-12">
    {{-- <label>المرحله</label> --}}
    <select class="form-control selectpicker" name="stage_id" onchange="getstage_years(this);filter_students();"
        id="stage_id" title="ادخل المرحله ">
...
<div class="form-group col-lg-2 col-md-6 col-12">
    ...
    <select class="form-control selectpicker" name="years_id" id="years_id"
        onchange="getyear_subjects(this);filter_students();" title="اختر السنه">
...
<div class="form-group col-lg-2 col-md-6 col-12">
    {{-- <label>الماده </label> --}}
    <select class="form-control selectpicker" name="subjects_id" id="subjects_id" onchange="getSubject_teacher(this)"
        title="اختر الماده">

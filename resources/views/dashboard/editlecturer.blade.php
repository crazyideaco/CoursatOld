  ...
  <!--start page-body-->
        <div class="page-body">
            <div class="container">
               ...
               <!--start heed-->
                ...
                <div class="setting">
                    <div class="container">
                     ...
                     <form method="post" action="{{route('updatelecturer',$lecturer->id)}}" enctype="multipart/form-data">
                        	@csrf
                         
                                    
                                <div class="row">
                            <div class="col-lg-3 col-md-6 col-12 text-center set-img">
                               <img src="{{asset('uploads/'.$lecturer->image)}}" id="realimg">
                    <br>
                               ...
                               <img src="{{asset('uploads/'.$lecturer->cover_image)}}" id="realimg3">
                    <br>
                               <input id="ad3" type="file" class="form-control ehabtalaat"  name="cover_image">
                                 ...
                                 @enderror
									...
									<div class="col-lg-3 col-md-6 col-12 text-center set-img">
                               <img src="{{asset('uploads/'.$lecturer->printsplash)}}" id="realimg2">
                    <br>
              ...
              <source src="{{asset('uploads/'.$lecturer->intro)}}" id="video_here">
                   ...
                   <input id="kt" type="file" class="form-control ehabtalaat" name="intro">
                        ...
                        <div class="info">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الايميل</label>
                                    <input class="form-control" type="text" name="email" value="{{$lecturer->email}}">
                                     @error('email')
                                 <p style="color:red;">{{$message}}</p>
                                 @enderror
                                </div>
                      ...
                      <select name="state_id" class="form-control" onchange="getcity(this)">
                          ...
                          <option value="{{$state->id}}" @if($lecturer->state_id == $state->id) selected @endif>{{$state->state}}</option>
                          @endforeach
                          </select>
                          </div>
                             <div class="form-group col-lg-3 col-md-6 col-12">
                      ...
                      <select name="city_id" class="form-control" id="city">
                          ...
                          <option value="{{$city->id}}" @if($lecturer->city_id == $city->id) selected @endif>{{$city->city}}</option>
                          @endforeach
                          </select>
                          </div>
                           <div class="form-group col-lg-3 col-md-6 col-12">
                               <label>العنوان</label>
                               <input type="text" name="address" class="form-control" value="{{$lecturer->address}}">
                           </div>
                           
                           <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>القسم العام</label>
                      <select name="general_id" class="form-control" onchange="getsub(this)">
                          <option value="0" selected="selected" disabled>
                              اختر قسم عام
                          </option>
                          @foreach($generals as $general)
                          <option value="{{$general->id}}" @if($lecturer->general_id == $general->id) selected @endif>{{$general->name_ar}}</option>
                          @endforeach
                      </select>
                             @error('general_id')
                                 <p style="color:red;">{{$message}}</p>
                        ...
                        <select name="sub_id[]" class="form-control  selectpicker" multiple id="subs">
                          <option value="0" selected="selected" disabled>
                              اختر قسم فرعى
                          </option>
                         @foreach($subs as $sub)
                          <option value="{{$sub->id}}" @if($lecturer->subs->pluck('id')->contains($sub->id)) selected @endif >{{$sub->name_ar}}</option>
                          @endforeach
                      </select>
                       @error('sub_id')
                                 <p style="color:red;">{{$message}}</p>
                        ...
                        <div class="form-group col-md-6 col-12">
                                   <label>الوصف</label>
                                   <textarea class="form-control" rows="5" name="description">{{$lecturer->description}}</textarea>

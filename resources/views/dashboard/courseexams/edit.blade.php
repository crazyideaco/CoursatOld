          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatecourseexam',$exam->id)}}" enctype="multipart/form-data">
                        	@csrf
                            <section id="section">
                        <div class="info">   
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                             ...
                             <!--  <div class="col-1">
                              ...
                              <input type="radio" name="duration" value="0" onchange="display2()"   >
                               ...
                               <div id="his" class="row col-lg-6 col-12 p-0">
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                              <span class="btn btn-danger w-100 my-2 text-white pl-3" onclick="addquestion3()">
                                بنك الاسئله الخاص 
                              </span>
                            </div>
                          </div>

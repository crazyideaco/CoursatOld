                        ...
                        <div class="products-search typs1">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                  ...
                                  <a href="{{route('addcourseexam',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة امتحان  
                                        </a>
                                    </button>
                              </div>
         ...
         <td scope="col" class="text-center">{{$exam->sub->name_ar}}</td>
                      ...
                      <td class="text-center">{{$exam->date_day}} </td>
                        <td class="text-center">
                                ...
                                <a href="{{route('editcourseexam',$exam->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 

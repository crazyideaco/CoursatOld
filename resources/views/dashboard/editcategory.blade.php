                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="{{route('storecategory',$category->id)}}" enctype="multipart/form-data">
                        	@csrf
                          
                        <div class="row">
                            <div class="col-12 text-center set-img">
								        <img src="{{asset('category/'.$category->image)}}" id="realimg">
                                   <br>
                    ...
                    <input type="text" class="form-control" 
                            placeholder="ادخل اسم " name="name" value="{{$category->name}}"> 
                            @error('name')
                            <div class="alert alert-danger">هذا الحقل مطلوب</div>
                            @enderror
                           </div>

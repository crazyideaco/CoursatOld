...
@section('content')
          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatesubjectscollegequestionscenter',$part->id)}}" enctype="multipart/form-data">
                        	@csrf
                            ...
                            <div class="row">
                                   ...
                                   <select name="university_id" required class="form-control" onchange="getcolleges(this)">
                                       ...
                                       <option value="{{$university->id}}" @if($part->university_id == $university->id) selected @endif>
                                           {{$university->name_ar}}
                                           </option>
                                       @endforeach
                                   </select>
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="college_id" required class="form-control" id="college" onchange="getdivision(this)">
                                       ...
                                       <option value="{{$college->id}}" @if($part->college_id == $college->id) selected @endif>{{$college->name_ar}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="division_id" required class="form-control" id="division" onchange="getsection(this)">
                                       ...
                                       <option value="{{$division->id}}" @if($part->division_id == $division->id) selected @endif>{{$division->name_ar}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="section_id" required class="form-control" id="section" onchange="getsubcollege(this)" >
                                       ...
                                       <option value="{{$section->id}}" @if($part->section_id == $section->id) selected @endif>{{$section->name_ar}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="subjectscollege_id" required class="form-control" id="subcollege" onchange="getdoctor(this)" >
                                       ...
                                       <option value="{{$subcollege->id}}" @if($part->subjectscollege_id == $subcollege->id) selected @endif>{{$subcollege->name_ar}}</option>
                                       @endforeach
                                   </select>
                                </div>
                      ...
                      <select name="doctor_id" class="form-control" required  id="doctor">
                          ...
                          <option value="{{$user->id}}" @if($part->doctor_id == $user->id) selected @endif>{{$user->name}}</option>
                          @endforeach
                      </select>
                           </div>  
                         </div>
 ...
 <div class="col-lg-3 col-md-6 col-12">
   <label>القسم</label>
   <input type="text" class="form-control w-100" name="part" value="{{$part->name}}">
                </div>                
                          </div>
                         <section id="section">
                              ...
                              <input type="text" class="form-control" name="name[{{$key}}]" value="{{$question->name}}">
                                   ...
                                   <div class="col-12 text-center">
                                     @if($question->question_image)
                                        <img src="{{asset('uploads/'.$question->question_image)}}" id="realimg" style="width:60%;height:300px;">
                                     @else
          ...
          <br>
          <br>
                   <input id="kt" type="file" class="form-control ehabtalaat"  name="video[{{$key}}]">
                           ...
                           <div class="col-lg-3 col-md-6 col-12 text-center set-img">
                             ...
                             @endif
                    <br>
                   <input id="ad2" type="file" class="form-control ehabtalaat"  name="image[{{$key}}]">
                           ...
                           <img src="{{asset('plus.png')}}" style="width:40px;height:40px;cursor:pointer;margin:20px auto;display:block;" id="click" onclick="addquestion()">
                            </div>
                          </div>
                          @else
                            ...
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[{{$key}}]" value="{{$question->name}}">
                                   ...
                                   <div class="col-lg-3 col-md-6 col-12 text-center">
                                     @if($question->question_image)
                                        <img src="{{asset('uploads/'.$question->question_image)}}" id="r{{$question->id}}"style="width:60%;height:300px;">
                                     @else
                               <img src="{{asset('images/set-img.svg')}}"  id="r{{$question->id}}" style="width:60%;height:300px;">
                                     @endif
                    <br>
                   <input id="d{{$question->id}}" type="file" class="form-control ehabtalaat"  onchange="getimage({{$question->id}})" name="question_image[{{$key}}]" style="width:50px;height:50px;">
          ...
          <br>
          <br>
                   <input id="kt{{$question->id}}" type="file" class="form-control ehabtalaat"  onchange="getvideo({{$question->id}})"  name="video[{{$key}}]">
                           ...
                           <div class="col-lg-3 col-md-6 col-12 text-center set-img">
                                @if($question->image)
                             <img src="{{asset('uploads/'.$question->image)}}" id="b{{$question->id}}">
                             @else
                               <img src="{{asset('images/set-img.svg')}}" id="b{{$question->id}}">
                             @endif
                    <br>
                   <input id="real{{$question->id}}" type="file" class="form-control ehabtalaat" onchange="getboard({{$question->id}})"  name="image[{{$key}}]">
                            <label for="real{{$question->id}}" class="ahmed">اضافة صوره</label>
                            @error('image')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
               </div>
                              <div class="col-lg-3 col-md-6 col-12">
                                                  ...
                                                  <img src="{{asset('remove.png')}}" style="width:40px;height:40px;cursor:pointer;margin:20px auto;display:block" 

          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatesubjectquestionscenter',$part->id)}}" enctype="multipart/form-data">
                        	@csrf
                         ...
                         <div class="row">
                           ...
                           <label>سنه الماده</label>
                            <select class="form-control" name="years_id" required id="year" onchange="getyear(this)">
                                ...
                                <option value='{{$year->id}}' @if($part->years_id == $year->id) selected @endif>{{$year->year_ar}}</option>
                                @endforeach
                            </select>
                                 @error('years_id')
                         <p style="color:red;">{{$message}}</p>
                           ...
                           <label>الماده </label>
                            <select class="form-control" name="subjects_id" required id="subject" onchange="getteacher(this)">
                                ...
                                <option value='{{$subject->id}}'  @if($part->subjects_id == $subject->id) selected @endif>{{$subject->name_ar}}</option>
                                @endforeach
                            </select>
                                 @error('subjects_id')
                         <p style="color:red;">{{$message}}</p>
                      ...
                      <select name="teacher_id" required class="form-control" id="teacher">
                          ...
                          <option value="{{$user->id}}" @if($part->teacher_id == $user->id) selected @endif>{{$user->name}}</option>
                          @endforeach
                      </select>
                            @error('teacher_id')
                         <p style="color:red;">{{$message}}</p>
                              ...
                              <textarea  class="form-control" rows="6" name="name[{{$key}}]">{{$question->name}}</textarea>
                                   ...
                                   <div class="col-12 text-center">
                                     @if($question->question_image)
                                        <img src="{{asset('uploads/'.$question->question_image)}}" id="realimg" class="my-3" style="width:100%;height:500px;">
                                     @else

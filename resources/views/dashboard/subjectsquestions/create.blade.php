                        ...
                        <div class="info">
                          ...
                          <div class="row">
                            <div class="col-12 text-center">
                               <img src="{{asset('images/set-img.svg')}}" id="realimg" style="width:250px;height:300px;">
                                <br>
                               <input id="ad" type="file" class="form-control ehabtalaat"  name="question_image[0]" style="width:100px;height:100px;">
  ...
  $("#click").click(function(){
    $("#section").append(` 
      <div class="info" id="s${id}">
                          ...
                          <div class="row">
                            <div class="col-12 text-center">
                               <img src="{{asset('images/set-img.svg')}}" id="r${id}" style="width:250px;height:300px;">
                                <br>

          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatesubjectquestions',$part->id)}}" enctype="multipart/form-data">
                        	@csrf
                  <div class="row mt-4">
   ...
   <input type="text" class="form-control w-100" name="part" value="{{$part->name}}">
                              ...
                              <input type="text" class="form-control" name="name[{{$key}}]" value="{{$question->name}}">
                                   ...
                                   <div class="col-12 text-center">
                                     @if($question->question_image)
                                        <img src="{{asset('uploads/'.$question->question_image)}}" id="realimg" style="width:100%;height:500px;">
                                     @else
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-3 col-12">
                              ...
                              <textarea rows="13" class="form-control" name="notes[{{$key}}]">{{$question->notes}}</textarea>
                               ...
                               <div class="col-lg-3 col-12 text-center mb-5 set-img">
                                   @if($question->video)
          ...
          <br>
                   <input id="kt" type="file" class="form-control ehabtalaat"  name="video[{{$key}}]">
                           ...
                           <div class="col-lg-3 col-12 text-center set-img">
                                @if($question->image)
                    ...
                    <div class="info" id="s{{$question->id}}">
                          ...
                          <div class="row">
                            <div class="col-12 text-center">
                                     ...
                                     @else
                               <img src="{{asset('images/set-img.svg')}}"  id="r{{$question->id}}" style="width:250px;height:300px;">
                                     @endif
                    <br>
  ...
  $source.parent()[0].load();
      ...
      success:function(data)
      {
        ...
        if(data.success)
        {
          ...
          location.href =`../subjectquestionss/${data.id}`;
        }
      }
    });function getvideo(c){
      ...
      <div class="info" id="s${id}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-3 col-md-12">
                              ...
                              <textarea rows="13" class="form-control" name="notes[${id}]"></textarea>
                               ...
                               <div class="col-lg-3 col-md-12 text-center mb-5 set-img">
                    <video width="200" height="200" controls >
          ...
          <br>
                   <input id="kt${id}" type="file" class="form-control ehabtalaat" onchange="getvideo(${id})"  name="video[${id}]">
                           ...
                           <div class="col-lg-3 col-md-12 text-center set-img">

                                        ...
                                        @foreach ($lecturers as $lecturer)
                                            <tr id="c{{ $lecturer->id }}">
                                                ...
                                                <td scope="col" class='text-center'><a
                                                        href="{{ route('lecturerprofile', $lecturer->id) }}">{{ $lecturer->name }}</a>
                                                </td>
                                                ...
                                                <td scope="row" class='text-center'>
                                                    <img src="{{ url('uploads/' . $lecturer->image) }}"
                                                        style="width:120px;height:120px">
                                                </td>

                                                <td scope="col" class="text-center">
                                                    {{ $lecturer->general->name_ar ?? '' }}</td>
                                                <td>
                                                    <?php $usersub = \App\Sub_User::where('user_id', $lecturer->id)
                                                        ->pluck('sub_id')
                                                        ->toArray();
                                                ...
                                                <td class="text-center">
                                                    <span class="btn btn-sm"
                                                        ...
                                                        id="btn{{ $lecturer->id }}"
                                                        onclick="activeuser({{ $lecturer->id }})">

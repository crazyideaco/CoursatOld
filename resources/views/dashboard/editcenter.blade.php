  ...
  <!--start page-body-->
        <div class="page-body">
            <div class="container">
                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="{{route('updatecenter',$center->id)}}" enctype="multipart/form-data">
                        	@csrf
                         
                                    
                                <div class="row">
                            <div class="col-lg-3 col-md-6 col-12 text-center set-img">
                               <img src="{{asset('uploads/'.$center->image)}}" id="realimg">
                    <br>
                               <input id="ad" type="file" class="form-control ehabtalaat"  name="image">
								...
								<div class="col-lg-3 col-md-6 col-12 text-center set-img">
                                <img src="{{asset('uploads/'.$center->cover_image)}}" id="realimg3">
                    <br>
                               ...
                               <img src="{{asset('uploads/'.$center->printsplash)}}" id="realimg2">
                    <br>
              ...
              <source src="{{asset('uploads/'.$center->intro)}}" id="video_here">
          ...
          <br>
                   <input id="kt" type="file" class="form-control ehabtalaat" name="intro">
                        ...
                        <div class="info">
                            <div class="row">
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الاسم</label>
                                    <input class="form-control" type="text" name="name" value="{{$center->name}}">
                                    @error('name')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                                </div>
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الايميل</label>
                                    <input class="form-control" type="text" name="email" value="{{$center->email}}">
                                    @error('email')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                                </div>
                            ...
                            @enderror
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الهاتف</label>
                                    <input class="form-control" type="text" name="phone" value="{{$center->phone}}">
                                    @error('phone')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                                </div>
                      ...
                      <select name="state_id" class="form-control" onchange="getcity(this)">
                          ...
                          <option value="{{$state->id}}" @if($center->state_id == $state->id) selected @endif>{{$state->state}}</option>
                          @endforeach
                          </select>
                          </div>
                             <div class="form-group col-lg-3 col-md-6 col-12">
                      <select name="city_id" class="form-control" id="city">
                          ...
                          <option value="{{$city->id}}" @if($center->city_id == $city->id) selected @endif>{{$city->city}}</option>
                          @endforeach
                          </select>
                          </div>
                           <div class="form-group col-lg-3 col-md-6 col-12">
                               <input type="text" name="address" class="form-control" value="{{$center->address}}" placeholder="ادخل العنوان">
                               @error('address')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                           </div>
								 <div class="form-group col-lg-3 col-md-6 col-12">
                                       ...
                                       <option value="{{$category->id}}" @if($center->category_id == $category->id) selected @endif>{{$category->name}}</option>
                           ...
                           <div class="row">
                               <div class="form-group col-12">
                                   <label>الوصف</label>
                                   <textarea class="form-control" rows="5" name="description">{{$center->description}}</textarea>
                                   @error('description')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                               </div>

                    ...
                    <div class="container">
                        ...
                        <div class="info">
                            ...
                            @enderror
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الايميل</label>
                                    <input class="form-control" value="{{$admin->email}}"  type="text" name="email">
                                    @error('email')
                            <p style="color:red;">{{$message}}</p>
                            @enderror
                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade show {{$index == 0 ? 'active' : ''}}" id="{{$model}}">
                                        @foreach($maps as $key => $map)
                                            <div class="checkbox checkbox-success form-check-inline">
                                                <input type="checkbox" name="permissions[]" id="inlineCheckbox{{$key}}" value="{{$model}}-{{$map}}" @if($admin->hasPermission($model .'-'.$map))  checked @endif>

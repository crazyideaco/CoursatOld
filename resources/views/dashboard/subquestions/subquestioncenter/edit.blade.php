          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatesubquestioncenters',$part->id)}}" enctype="multipart/form-data">
                        	@csrf
                      ...
                      <select name="general_id" class="form-control" required onchange="getsub(this)">
                          ...
                          <option value="{{$general->id}}" @if($part->general_id == $general->id) selected @endif>{{$general->name_ar}}</option>
                          @endforeach
                      </select>
                      @error('general_id')
                     ...
                     <div class="form-group col-lg-4 col-md-6 col-12">
                        ...
                        <select name="sub_id" class="form-control" id="sub"  required onchange="getlecturer(this)">
                          <option value="0" selected="selected" disabled>
                              ...
                              @foreach($subs as $sub)
                          <option value="{{$sub->id}}" @if($part->sub_id == $sub->id) selected @endif>{{$sub->name_ar}}</option>
                          @endforeach
                       ...
                       @error('sub_id')
                        ...
                        <select name="user_id" class="form-control" required id="lecturer" required>
                         ...
                         <option value="{{$lect->id}}" @if($part->user_id == $lect->id) selected @endif>{{$lect->name}}</option>
                         @endforeach
                      </select>
                        </div>
                            ...
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[{{$key}}]" value="{{$question->name}}">
                                   ...
                                   <div class="col-lg-4 col-md-6 col-12 text-center">
                                     @if($question->question_image)
                                        <img src="{{asset('uploads/'.$question->question_image)}}" id="r{{$question->id}}"style="width:100px;height:100px;">
                                     @else
                               <img src="{{asset('images/set-img.svg')}}"  id="r{{$question->id}}" style="width:100px;height:100px;">
                                     @endif
                    <br>

                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <button class="btn w-100 mx-auto" >
                                      <a href="{{route('addsubquestion',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة   سؤال 
                                        </a>
                                    </button>
        ...
        <tbody>
                    ...
                    <td scope="row" class="text-center">{{$question->name}}</td>
                        ...
                        <td class="text-center">
                          <a href="{{route('editsubquestion',$question->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 

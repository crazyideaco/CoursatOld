          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="{{route('updatesubquestion',$part->id)}}" enctype="multipart/form-data">
                        	@csrf
                  <div class="row mt-4">
                            ...
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[{{$key}}]" value="{{$question->name}}">
                               ...
                               <img src="{{asset('images/set-img.svg')}}" id="realimg" style="width:60%;height:300px;">
                                     @endif
                    <br>
                   <input id="ad" type="file" class="form-control ehabtalaat"  name="question_image[{{$key}}]" style="width:60%;height:300px;">
  ...
  $source.parent()[0].load();
      ...
      success:function(data)
      {
        ...
        if(data.success)
        {
          ...
          location.href =`../subquestions/${data.id}`;
        }
      }
    });function getvideo(c){

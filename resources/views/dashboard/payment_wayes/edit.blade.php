                        ...
                        <div class="info">
                            <div class="row">
                                ...
                                <div class="form-group col-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="ادخل الاسم " name="title"
                                        value="{{ $paymentway->title }}"required>
                                    @error('title')
                                ...
                                <div class="form-group col-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="ادخل الرقم " name="number"
                                        value="{{ $paymentway->number }}"required>
                                    @error('number')
                                        <div style="color:red;">{{ $message }} </div>
                                    @enderror
                                </div>
                                ...
                                {{-- @if (auth()->user()->isAdmin === 'admin')
                                    <div class="form-group col-3">
                                        ...
                                        <select class="form-control" multiple name="center_id[]" required>

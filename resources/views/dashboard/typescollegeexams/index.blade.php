                ...
                <div class="setting all-products typs">
                    <div class="container">
                        ...
                        <div class="products-search typs1">
                            <div class="row">
                                    <button class="btn" >
                                  <a href="{{route('addtypescollegeexam',$id)}}">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة امتحان  
                                        </a>
                                    </button>
                   ...
                   {{$exam->typescollege->name_ar}}</td>
                      ...
                      <td class="text-center">{{$exam->date_day}} </td>
                        <td class="text-center">
                                ...
                                <a href="{{route('edittypescollegeexam',$exam->id)}}" > <img src="{{asset('images/pen.svg')}}" id="pen" 
                         style="cursor: pointer"></a>
                      
                           <img src="{{asset('images/trash.svg')}}" id="trash" onclick="deletegroup('{{$exam->id}}')" style="cursor:pointer;"> 
                <a href="{{route('typecollegeexamresults',$exam->id)}}" class="btn btn-success btn-sm mt-3" >نتائج الامتحان</a>
                                            </td>
                                        </tr>                            
                                        @endforeach
                                    </tbody>

                       ...
                       <div class="form-group col-6">
                         ...
                         <p style="color:red;">{{$message}}</p>
                          ...
                          <div class="row">
                            ...
                            <span class="btn btn-primary" onclick="filterbasicstudents()">بحث</span>    </div>
                          </div>
                            <div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       @foreach($types as $type)
        ...
        <div class="row mt-4">
          <button type="button text-center" onclick="addtypestudent({{$student->id}})" class="btn btn-success">
            حفظ
          </button>
        </div>
      </div>

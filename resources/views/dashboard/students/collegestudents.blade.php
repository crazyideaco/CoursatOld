                    ...
                    <div class="pt-5">
                        ...
                        <div class="row">
                            <div class="col-3 mx-auto">
                                ...
                                <span class="btn btn-primary" onclick="filtercollegestudents()">بحث</span>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <tbody id="students">
                                        @foreach ($students as $student)
                                            <tr id="s{{ $student->id }}">
                                                ...
                                                <?php $types = \App\TypesCollege::where('section_id', $student->section_id)
                                                    ->whereNotIn('id', $student->stutypescollege->pluck('id')->toArray())
                                                    ->get();
                                                ?>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row  mt-4">
                                                                        <button type="button text-center"
                                                                            onclick="addtypesollegestudent({{ $student->id }})"

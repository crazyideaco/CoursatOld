          ...
          <br>
                   <input id="kt" type="file" class="form-control ehabtalaat" name="intro">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                 ...
                                 @enderror
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الهاتف</label>
                                    <input class="form-control" type="text" required name="phone" value="{{$teacher->phone}}">
                                     @error('phone')
                                 <p style="color:red;">{{$message}}</p>
                                 @enderror
                                </div>
                      ...
                      <select name="state_id" class="form-control" onchange="getcity(this)">
                          ...
                          <option value="{{$state->id}}" @if($teacher->state_id == $state->id) selected @endif>{{$state->state}}</option>
                          @endforeach
                          </select>
                          </div>
                             <div class="form-group col-lg-3 col-md-6 col-12">
                      ...
                      <select name="city_id" class="form-control" id="city">
                          ...
                          <option value="{{$city->id}}" @if($teacher->city_id == $city->id) selected @endif>{{$city->city}}</option>
                          @endforeach
                          </select>
                          </div>
                           <div class="form-group col-lg-3 col-md-6 col-12">
                      ...
                      <select name="state_id" class="form-control" onchange="getstage(this)" required>
                          ...
                          <option value="{{$stage->id}}" @if($teacher->stage_id == $stage->id) selected @endif>{{$stage->name_ar}}</option>
                          @endforeach
                          </select>
                          </div>
                            </div>
                         ...
                         <label>السنه الدراسيه :</label>
                          ...
                          <option value="{{$year->id}}" @if($teacher->years->pluck('id')->contains($year->id)) selected @endif>{{$year->year_ar}}</option>
                          @endforeach
                      </select>
                        </div>
                              <?php 
                      ...
                      <select name="subject_id[]" class="form-control selectpicker"  required multiple="multiple" id="subject">
                          ...
                          <option value="{{$subject->id}}" @if($usersubject->contains($subject->id)) selected @endif>{{$subject->name_ar}}</option>
                          @endforeach
                      </select>

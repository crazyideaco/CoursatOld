                   ...
                   <input id="ad" type="file" class="form-control ehabtalaat" name="image">
                            ...
                            <div class="row">
                                <div class="form-group col-3">
                                    ...
                                    <input class="form-control" type="text" name="name_ar" required value="{{$typescollege->name_ar}}">
                                </div>   
                                <div class="form-group col-3">
                                    <label>اسم البارت بالانجليزي</label>
                                    <input class="form-control" type="text" name="name_en" required value="{{$typescollege->name_en}}">
                                </div>
                                  <div class="form-group col-3">
                                   ...
                                   <select name="university_id" required class="form-control" onchange="getcolleges(this)">
                                       ...
                                       <option value="{{$university->id}}" @if($typescollege->university_id == $university->id) selected
                                        @endif</option>
                                           {{$university->name_ar}}
                                           </option>
                                       @endforeach
                                 ...
                                 <div class="form-group col-3">
                                   ...
                                   <select name="college_id" class="form-control" id="college" onchange="getdivision(this)">
                                       ...
                                       <option value="{{$college->id}}" @if($typescollege->college_id ==
                                 ...
                                 <div class="form-group col-3">
                                   ...
                                   <select name="division_id" class="form-control" id="division" onchange="getsection(this)">
                                       ...
                                       <option value="{{$division->id}}"@if($typescollege->division_id ==
                                ...
                                <div class="form-group col-3">
                                   ...
                                   <select name="section_id" class="form-control" id="section" onchange="getsubcollege(this)" >
                                       ...
                                       <option value="{{$section->id}}" @if($typescollege->section_id ==
                                ...
                                <div class="form-group col-3">
                                   ...
                                   onchange="getdoctor(this)" >
                                       ...
                                       <option value="{{$subcollege->id}}" @if($typescollege->subjectscollege_id ==
                                        $subcollege->id) selected @endif>{{$subcollege->name_ar}}</option>
                                       @endforeach
                                   </select>
                                </div>
                                     <div class="form-group col-3">
                      ...
                      <select name="doctor_id" class="form-control" required id="doctor">
                          ...
                          <option value="{{$user->id}}" @if($typescollege->doctor_id ==
                          ...
                          @endforeach
                                ...
                                <select class="form-control selectpicker"  data-live-search="true"  multiple name="tag_id[]">
                                  ...
                                  @foreach($tags as $tag)
                                  <option value="{{$tag->id}}" @if(in_array($tag->id,$typescollege->tags->pluck('id')->toArray())) selected @endif>{{$tag->name}}</option>
                                  @endforeach
                                </select>
                              </div>
                                 <div class="form-group col-3">
                             ...
                             <div class="row">
                                <div class="form-group col-3">
                                    <label> اسم البارت بالعربى  </label>
                                    <input class="form-control" type="text" required name="name_ar" value="{{$typescollege->name_ar}}">
                                </div>   
                                <div class="form-group col-3">
                                    <label>اسم البارت بالانجليزي</label>
                                    <input class="form-control" type="text" required name="name_en" value="{{$typescollege->name_en}}">
                                </div>
                                 <div class="form-group col-3">
                                    <label>اسم الجامعه </label>
                                   <select name="university_id" required class="form-control" onchange="getcolleges(this)">

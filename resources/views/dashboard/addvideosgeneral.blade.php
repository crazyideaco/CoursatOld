   ...
   @enderror
                <div class="setting">
                    <div class="container">
                      ...
                      <form method="post" action="{{route('storevideosgeneral',$id)}}" enctype="multipart/form-data">
                        	@csrf
         ...
         <br>
                             ...
                             <div class="col-6 text-center set-img">
                                ...
                                <br>
                               <input id="ad2" type="file" class="form-control ehabtalaat" required name="board">
                   ...
                   <input type="text" class="form-control" id="name_en" required name="name_en">
                           </div>
        
                            <div class="form-group col-3">
                                     
                                   <label for="pay">مدفوع</label><br >
                                   <input id="pay" style="width: 13px;" type="checkbox" checked value="1" name="pay">
                   ...
                   <input type="text" class="form-control" id="name_en" required name="name_en">
                           ...
                           <div class="row">
                               <div class="form-group col-6">
                                   ...
                                   <label>الوصف بالعربيه</label>
                                   <textarea class="form-control " id="description_ar" rows="5" name="description_ar"></textarea>
                               </div>
                                <div class="form-group col-6">

                                   <label>الوصف بالانجليزيه</label>
                                   <textarea class="form-control " id="description_en" rows="5" name="description_en"></textarea>
                               </div>
                           </div>
                        ...
                        <div class="info">
                            <div class="row">
                                     ...
                                     <div class="form-group col-3">
                              <label>عنوان الفيديو بالعربى </label>
                   <input type="text" id="name_ar" class="form-control" required name="name_ar">
                           </div>            <div class="form-group col-3">
                              <label>عنوان الفيديو بالانجليزي </label>
                   <input type="text" id="name_en" class="form-control" required name="name_en">
                           </div>     
  ...
  $('form').ajaxForm({
      ...
      beforeSend:function(){
        ...
        $('#success').empty();
                ...
                <?php
$msg = null;
$type = \App\Course::where('id',$id)->first();
if(auth()->user() && auth()->user()->isAdmin == 'admin'){

                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="{{route('updatesection',$section->id)}}" enctype="multipart/form-data">
                        	@csrf
                        ...
                        <div class="info">
                            <div class="row">
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    ...
                                    <input class="form-control" type="text" name="name_ar" value="{{$section->name_ar}}">
									  @error('name_ar')
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    ...
                                    <input class="form-control" type="text" name="name_en" value="{{$section->name_en}}">
									    @error('name_en')
                                    <p style="color:red;">{{$message}}</p>
                                    @enderror
                                </div>
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="university_id" class="form-control" onchange="getcolleges(this)">
                                       ...
                                       @if($section->university_id == $university->id)
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="college_id" class="form-control" id="college" onchange="getdivision(this)">
                                       ...
                                       <option value="{{$college->id}}" @if($section->college_id == $college->id)
                                       selected @endif
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="division_id" class="form-control" id="division">
                                       ...
                                       selected @endif>{{$division->name_ar}}</option>
                                       @endforeach
                                   </select>
									   @error('division_id')
                                    <p style="color:red;">{{$message}}</p>

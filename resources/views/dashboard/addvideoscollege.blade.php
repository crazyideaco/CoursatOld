        ...
        <div class="container">
            ...
            <div class="setting">
                <div class="container">
                    ...
                    <form method="post" action="{{ route('storevideoscollege', $id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            {{-- youtube --}}
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <input id="youtube_link" type="text" class="form-control" name="youtube_link" placeholder="قم بإضافة لينك يوتيوب اذا أردت">
                        ...
                        @if (Auth::user() && Auth::user()->isAdmin == 'admin')
                            ...
                            <div class="info">
                                <div class="row">
                                    <div class="col-3 form-group">
                                        <label>عنوان الفيديو بالعربى</label>
                                        <input id="name_ar" type="text" class="form-control" required
                                            name="name_ar" placeholder="الاسم">
                                        @error('name_ar')
                                            <p style="color:red;">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-3 form-group">
                                        <label>عنوان الفيديو بالانجليزي</label>
                                        <input id="name_en" type="text" class="form-control" required
                                            name="name_en" placeholder="الاسم">
                                        @error('name_en')
                                            <p style="color:red;">{{ $message }}</p>
                                        @enderror
                                    </div>

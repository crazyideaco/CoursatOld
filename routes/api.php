...
Route::group(['namespace' => 'api'], function () {
    ...
    Route::get('screenshot_session_api', 'WhatsappController@screenshot_session_api');
    ...
    Route::get('fetch_buy_points', 'PointController@fetch_buy_points')->middleware('auth:api');
    ...
    Route::post('course_code_status', 'CourseCodeController@course_code_status')->middleware('auth:api');

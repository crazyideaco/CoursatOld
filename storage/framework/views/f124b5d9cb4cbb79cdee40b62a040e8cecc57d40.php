                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="<?php echo e(route('storedivision')); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                        ...
                        <div class="info">
                            <div class="row">
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    ...
                                    <input class="form-control" value="<?php echo e(old('name_ar')); ?>" type="text" name="name_ar">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                    ...
                                    <input class="form-control" value="<?php echo e(old('name_en')); ?>"  type="text" name="name_en">
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="college_id[]" multiple class="form-control selectpicker" id="college">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/adddivision.blade.php ENDPATH**/ ?>
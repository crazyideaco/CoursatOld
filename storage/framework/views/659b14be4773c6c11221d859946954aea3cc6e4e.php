                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="<?php echo e(route('updatesubcollege',$subcollege)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                 <label>اسم الماده بالعربى</label>
                                    <input class="form-control" type="text" name="name_ar" value="<?php echo e($subcollege->name_ar); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                 <label>اسم الماده بالانجليزي</label>
                                    <input class="form-control" type="text" name="name_en" value="<?php echo e($subcollege->name_en); ?>">
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <select name="university_id" class="form-control" onchange="getcolleges(this)">
                                       ...
                                       <?php if($subcollege->university_id == $university->id): ?> 
                                       selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="college_id" class="form-control" id="college" onchange="getdivision(this)">
                                       ...
                                       <option value="<?php echo e($college->id); ?>" <?php if($subcollege->college_id 
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="division_id" class="form-control" id="division" onchange="getsection(this)">
                                       ...
                                       <option value="<?php echo e($division->id); ?>" <?php if($subcollege->division_id 
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-lg-3 col-md-6 col-12">
                                   ...
                                   <select name="section_id" class="form-control" id="section" >
                                       ...
                                       <option value="<?php echo e($section->id); ?>" <?php if($subcollege->section_id 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/editsubcollege.blade.php ENDPATH**/ ?>
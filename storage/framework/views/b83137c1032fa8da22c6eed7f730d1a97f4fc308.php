                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="<?php echo e(route('storespecialcollege',$id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="info">
                            <div class="row">
                               ...
                               <input id="name" type="text" class="form-control"  required name="name_ar" value="<?php echo e(old('name_ar')); ?>"
                               placeholder="الاسم">
...
unset($__errorArgs, $__bag); ?>
                               ...
                               <input id="name" type="text" class="form-control" required name="name_en" value="<?php echo e(old('name_en')); ?>"
                               placeholder="الاسم">
...
unset($__errorArgs, $__bag); ?>  
                               ...
                               <input style="    height: 36px;" type="number" required name="points" value="<?php echo e(old('points')); ?>">
                               </div>
...
unset($__errorArgs, $__bag); ?>  
                                   ...
                                   <div class="form-group col-3">
                               <label>عدد النقط</label>
                               <input style="    height: 36px;" type="number" name="points" value="<?php echo e(old('points')); ?>">
                               </div>
...
unset($__errorArgs, $__bag); ?>  
                                   ...
                                   <div class="form-group col-3">
                               <label>عدد النقط</label>
                               <input style="    height: 36px;" required type="number" name="points" value="<?php echo e(old('points')); ?>">
                               </div>
...
function removes(id){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/addspecialcollege.blade.php ENDPATH**/ ?>
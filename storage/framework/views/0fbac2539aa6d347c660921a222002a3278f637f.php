...
@media  only screen and (max-width: 991.98px){
  ...
  .page-body .heed .flag, .page-body .heed .datee{
    width: 20%;
  }
}
...
@media  only screen and (max-width: 767.98px){
  ...
  .page-body .heed .profile, .page-body .heed .noti, .page-body .heed .flag, .page-body .heed .datee{
    width: 40%;
    margin: 2% 5%;
  }
  .page-body .heed .profile h5, .page-body .heed .profile p{
    font-size: 10px;
    margin: 0;
  }
}        
    ...
    <div class="s-layout__sidebar side-bar">
      ...
      <nav class="s-sidebar__nav">
            <div class="logo text-center">
                <h5><img src="<?php echo e(asset('images/pro.png')); ?>"
                style="width:100px;height:80px;margin-top:20px;"></h5>
            </div>
                      ...
                      <a href="<?php echo e(route('adddoctor')); ?>" class="<?php if(request()->is('adddoctor')): ?>active <?php endif; ?>">
                        ...
                        <a href="<?php echo e(route('userstudents')); ?>" class="<?php if(request()->is('userstudents')): ?>active <?php endif; ?>">
                          ...
                          <a href="<?php echo e(route('alllessonexamresults')); ?>" class="<?php if(request()->is('alllessonexamresults')): ?>active <?php endif; ?>">
                           ...
                           <a href="<?php echo e(route('subjectscollegequestionscenter')); ?>"
                            class="<?php if(request()->is('subjectscollegequestionscenter')): ?>active <?php endif; ?>">
                              بنك الاسئله</a>
...
</html><?php /**PATH C:\xampp\htdocs\Coursat\resources\views/App/dash.blade.php ENDPATH**/ ?>
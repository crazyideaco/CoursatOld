          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="<?php echo e(route('storesubjectscollegequestionscenter')); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                          ...
                          <div class="row">
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[0]">
                               ...
                               <img src="<?php echo e(asset('images/set-img.svg')); ?>" id="realimg" class="my-3" style="width:60%;height:300px;">
                    <br>
...
unset($__errorArgs, $__bag); ?>
                           ...
                           <img src="<?php echo e(asset('plus.png')); ?>" style="width:40px;height:40px;cursor:pointer;margin:20px auto;display:block;" id="click" >
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="name[${id}]">
                                   ...
                                   <div class="col-12 text-center">
                               <img src="<?php echo e(asset('images/set-img.svg')); ?>" id="r${id}" class="my-3" style="width:60%;height:300px;">
                    <br>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <img src="<?php echo e(asset('remove.png')); ?>" style="width:40px;height:40px;cursor:pointer;margin:20px auto;display:block;"  onclick="removequestion(${id})">
                            </div>
                          </div>
...
console.log(id);
 $.ajaxSetup({
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/subjectscollegequestions/subjectscollegequestionscenter/create.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <br>
                               <input id="ad2" type="file" class="form-control ehabtalaat" required name="printsplash">
...
unset($__errorArgs, $__bag); ?>
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الهاتف</label>
                                    <input class="form-control" type="number" min="0" id="phone" name="phone" value="<?php echo e(old('phone')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/adddoctor.blade.php ENDPATH**/ ?>
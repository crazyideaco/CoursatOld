                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                            ...
                            <form method="post" action="<?php echo e(route('storeadmin')); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                        <div class="info">
...
unset($__errorArgs, $__bag); ?>
                                  ...
                                  <div class="form-group col-lg-3 col-md-6 col-12">
                                    <label>الهاتف</label>
                                    <input class="form-control" value="<?php echo e(old('phone')); ?>"  type="text" name="phone">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade show <?php echo e($index == 0 ? 'active' : ''); ?>" id="<?php echo e($model); ?>">
                                        <?php $__currentLoopData = $maps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="checkbox checkbox-success form-check-inline">
                                                <input type="checkbox" name="permissions[]" id="inlineCheckbox<?php echo e($key); ?>" value="<?php echo e($model); ?>-<?php echo e($map); ?>">
...
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/admins/addadmin.blade.php ENDPATH**/ ?>
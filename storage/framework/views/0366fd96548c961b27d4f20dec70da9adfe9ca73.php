          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="<?php echo e(route('storetypescollegeexam',$id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                            <section id="section">
                        <div class="info">   
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/typescollegeexams/create.blade.php ENDPATH**/ ?>
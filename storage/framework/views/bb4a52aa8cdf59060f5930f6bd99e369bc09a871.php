      ...
      <div class="form-group col-5">
                                   ...
                                   <select name="video_id[]" class="form-control selectpicker"  required  >
                                    ...
                                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($video->id); ?>" <?php if($video->id == $newvideo->id): ?> selected <?php endif; ?>><?php echo e($video->name_ar); ?> - <?php echo e($type->name_ar); ?></option>
  ...
  $('#adds').click(function(){
    ...
    <div class="form-group col-5">
                                   ...
                                   <select name="video_id[]" class="form-control selectpicker"  required  >
                                       <option value="0" disabled="disabled" selected="selected"> اختر فيديو</option>
                                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($video->id); ?>"><?php echo e($video->name_ar); ?> - <?php echo e($type->name_ar); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                                </div>
    <div class="col-3 form-group">
...
function removes(id){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcours/public_html/resources/views/dashboard/editspecialcollege.blade.php ENDPATH**/ ?>
          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="<?php echo e(route('storesubjectscollegequestions',$id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/subjectscollegequestions/create.blade.php ENDPATH**/ ?>
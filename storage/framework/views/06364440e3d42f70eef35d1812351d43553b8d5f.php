    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-12">
            <div class="card_static card alert-info">
                ...
                <h5>عدد الطلاب</h5>
                <h4 class="counter"><?php echo e($students); ?></h4>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-12">
            <div class="card_static card alert-light">
                ...
                <h5>عدد الكورسات</h5>
                <h4 class="counter"><?php echo e($types); ?></h4>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-12">
            <div class="card_static card alert-warning">
                ...
                <h5>عدد المدرسين</h5>
                <h4 class="counter"><?php echo e($teachers); ?></h4>
            </div>
        </div>
    </div>
    <div class="row">
...
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/mainpage/college.blade.php ENDPATH**/ ?>
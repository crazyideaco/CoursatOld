                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <button class="btn w-100 mx-auto" >
                                      <a href="<?php echo e(route('addsubjectscollegequestionscenter')); ?>">  <span><i class="fas fa-plus-circle"></i></span>
                                        اضافة   سؤال 
                                        </a>
                                    </button>
                ...
                <td scope="row" class="text-center">
                   <?php echo e($question->division->name_ar); ?></td>
                    <td class="text-center">
                      <?php if($question->college): ?>
                      <?php echo e($question->college->name_ar); ?>

                      <?php endif; ?>
                      </td>
                          <td class="text-center">
                            <?php if($question->university): ?>
                            <?php echo e($question->university->name_ar); ?>

                      <?php endif; ?></td>
                        <td class="text-center">
                          <a href="<?php echo e(route('editsubjectscollegequestionscenter',$question->id)); ?>" > <img src="<?php echo e(asset('images/pen.svg')); ?>" id="pen" 
                         style="cursor: pointer"></a>
                              <?php if(auth()->user()->hasPermission("subjectscollegequestionscenter-delete")): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/subjectscollegequestions/subjectscollegequestionscenter/index.blade.php ENDPATH**/ ?>
                    ...
                    <div class="container">
                        <div class="row def">
                            ...
                            <h5>اضافه فيديو </h5>
                               ...
                               <form method="post" action="<?php echo e(route('storevideoscollege',$id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
...
<?php  }?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcourses.net/public_html/resources/views/dashboard/addvideoscollege.blade.php ENDPATH**/ ?>
                ...
                <div class="setting">
                    <div class="container">
                        ...
                        //  $videos = \App\VideosCollege::where('lesson_id',$sp->id)->get();
                          ?>
                            <form method="post" action="<?php echo e(route('updatespecialcollege',$sp->id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                        	  
                            <div class="row">
                           <div class="col-12 text-center set-img">
                         <input id="ad" type="file" class="form-control ehabtalaat"  name="image">
                           <img src="<?php echo e(asset('uploads/'.$sp->image)); ?>" id="realimg">
                                <br>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="info">
                            <div class="row">
                               ...
                               <input id="name" type="text" class="form-control"required value="<?php echo e($sp->name_ar); ?>" name="name_ar"
                               placeholder="الاسم">
...
unset($__errorArgs, $__bag); ?>
                               ...
                               <input id="name" type="text" class="form-control" required value="<?php echo e($sp->name_en); ?>" name="name_en"
                               placeholder="الاسم">
...
unset($__errorArgs, $__bag); ?>  
                               ...
                               <input style="    height: 36px;" type="number" name="points" required value="<?php echo e($sp->points); ?>">
                               </div>
                           ...
                           <?php elseif(Auth::user() && Auth::user()->is_student == 5 && Auth::user()->category_id == 2): ?>
                            ...
                            <div class="row">
                                  <div class="col-3 form-group">
                                        <label>عنوان الحصه بالعربى</label>
                               <input id="name" type="text" class="form-control" name="name_ar"  value="<?php echo e($sp->name_ar); ?>" 
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <div class="col-3 form-group">
                                        <label>عنوان الحصه بالانجليزي</label>
                               <input id="name" type="text" class="form-control" name="name_en"  value="<?php echo e($sp->name_en); ?>" 
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>  
                                   ...
                                   <div class="form-group col-3">
                               <label>عدد النقط</label>
                               <input style="    height: 36px;" type="number" name="points"  value="<?php echo e($sp->points); ?>">
                               </div>
                      ...
                      <div class="info">
                            <div class="row">
                                  <div class="col-3 form-group">
                                        <label>عنوان الحصه بالعربى</label>
                               <input id="name" type="text" class="form-control" required name="name_ar"  value="<?php echo e($sp->name_ar); ?>" 
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <div class="col-3 form-group">
                                        <label>عنوان الحصه بالانجليزي</label> 
                               <input id="name" type="text" class="form-control" required name="name_en"  value="<?php echo e($sp->name_en); ?>" 
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>  
                                   ...
                                   <div class="form-group col-3">
                               <label>عدد النقط</label>
                               <input style="    height: 36px;" type="number" required name="points" value="<?php echo e($sp->points); ?>">
                               </div>
                    ...
                    <?php endif; ?>
                         <section id="section">
                           <?php $__currentLoopData = $sp->videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $newvideo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           
       <div class="row" id="pre<?php echo e($key); ?>">
      <div class="form-group col-5">
                                   ...
                                   <select name="video_id[]" class="form-control selectpicker"  required  >
                                    ...
                                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($video->id); ?>" <?php if($video->id == $newvideo->id): ?> selected <?php endif; ?>><?php echo e($video->name_ar); ?> </option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                                </div>
          <div class="col-3 form-group">
                                        <label>  الاسم</label>
                               <input id="name" type="text" class="form-control" required name="name[]" value="<?php echo e($newvideo->name_ar); ?>"
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-2">
         <div class="radio">
  <label><input type="radio" name="paid[<?php echo e($key); ?>]"  value="1" <?php if($newvideo->paid == 1): ?> checked <?php endif; ?>> مدفوع</label>
</div>
<div class="radio">
  <label><input type="radio" name="paid[<?php echo e($key); ?>]" value="0"  <?php if($newvideo->paid == 0): ?> checked <?php endif; ?>> مجانى</label>
</div>
           </div>
         <?php if($loop->first): ?>
         <div class="col-2">
         ...
         <span id="adds" class="btn btn-danger" onclick="removes(<?php echo e($key); ?>)">حذف</span>
             </div> 
                           <?php endif; ?>
                           </div>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       ...
       <div class="row">
                               <div class="form-group col-md-6 col-12">
                                   ...
                                   <textarea class="form-control"
                                    ...
                                    name="description"><?php echo e($sp->description); ?></textarea>
                               </div>
                           </div>
  ...
  $('#adds').click(function(){
    ...
    <div class="form-group col-5">
                                   ...
                                   <select name="video_id[]" class="form-control selectpicker"  required  >
                                       <option value="0" disabled="disabled" selected="selected"> اختر فيديو</option>
                                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($video->id); ?>"><?php echo e($video->name_ar); ?></option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                                </div>
    <div class="col-3 form-group">
                                        <label>  الاسم</label>
                               <input id="name" type="text" class="form-control" required name="name[]" value="<?php echo e(old('name')); ?>"
                               placeholder="الاسم">
                                      <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
function removes(id){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Coursat\resources\views/dashboard/editspecialcollege.blade.php ENDPATH**/ ?>
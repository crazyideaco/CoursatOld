                ...
                <div class="setting">
                    <div class="container">
                        <div class="row def">
                          ...
                          <form method="post" action="<?php echo e(route('updatevideoscollege',$video->id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                               ...
                               <input id="ad" type="file" class="form-control ehabtalaat"  name="image">
                                         <img src="<?php echo e(asset('uploads/'.$video->image)); ?>" id="realimg">
                                <br>
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <div class="col-6 text-center set-img">
                                           <img src="<?php echo e(asset('uploads/'.$video->board)); ?>" id="realimg2">
                                <br>
...
unset($__errorArgs, $__bag); ?>  
                                 ...
                                 <div class="form-group col-3">
                                   ...
                                   <input id="pay" style="width: 13px;" type="checkbox"  value="1" name="pay" <?php if($video->paid == 1): ?> checked <?php endif; ?> >
...
<?php  }?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcourses.net/public_html/resources/views/dashboard/editvideoscollege.blade.php ENDPATH**/ ?>
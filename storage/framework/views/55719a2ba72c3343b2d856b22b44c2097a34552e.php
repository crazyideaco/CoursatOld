          ...
          <!--start setting-->
                <div class="setting">
                    <div class="container">
                       ...
                       <form method="post" action="<?php echo e(route('updatetypescollegeexam',$exam->id)); ?>" enctype="multipart/form-data">
                        	<?php echo csrf_field(); ?>
                            <section id="section">
                        <div class="info">   
                          ...
                          <div class="row">
                            <div class="col-4">
                              <label>الاسم</label>
                              <input type="text" name="name_ar" class="form-control"  value="<?php echo e($exam->name); ?>">
                            </div> <div class="col-4">
                              <label>عدد الاسئله</label>
                              <input type="number" name="question_number" class="form-control"  value="<?php echo e($exam->question_number); ?>">
                            </div>
                             <!--  <div class="col-1">
                              <label>تاريخ </label>
                            ...
                            <div class="col-6">
                              <label>التاريخ</label>
                              <input type="date" name="date_day" class="form-control"  value="<?php echo e($exam->date_day); ?>">
                            </div>
                            ...
                            <div class="col-6">
                              ...
                              <input type="time" name="date_time" class="form-control"  value="<?php echo e($exam->date_time); ?>" >
                            </div>
                          ...
                          <!--   <div class="col-1">
                             ...
                             <div class="col-4" style="display:block;" id="dur">
                              ...
                              <input type="number" name="duration_time" class="form-control"  value="<?php echo e($exam->duration_time); ?>">
                            </div>
                            <div class="col-2">
                               <label>الدرجه</label>
                              <input type="number" class="form-control" name="totalscore" value="<?php echo e($exam->score); ?>">
                            </div>
                          </div>
                          <div class="row mt-4">
                            <div class="col-4">
                              ...
                              <input type="text" class="form-control" name="name[<?php echo e($key); ?>]" value="<?php echo e($question->name); ?>">
                                   ...
                                   <div class="col-4 text-center">
                                     <?php if($question->question_image): ?>
                                        <img src="<?php echo e(asset('uploads/'.$question->question_image)); ?>" id="realimg" style="width:100px;height:100px;">
                                     <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                   ...
                   <div class="row">
                         ...
                         <div class="row">
                                <div class="col-6">
                           <img src="<?php echo e(asset('remove.png')); ?>" style="width:40px;height:40px;cursor:pointer;"  class="mt-4" onclick="removequestion(<?php echo e($question->id); ?>)">
                            </div>
                          </div>
                           </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('App.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/azcour/public_html/resources/views/dashboard/typescollegeexams/edit.blade.php ENDPATH**/ ?>
...
class TeacherController extends Controller
{
  ...
  public function addteacher(){
     ...
     with('subjects',Subject::all())->with('years',Year::all())->with('states',State::all())->with('stages',Stage::all());
 }
 ...
 public function teachers(){
    ...
    $teacher = User::where('id',$id)->firstOrFail();
     return view('dashboard.editteacher')->
     with('subjects',Subject::all())->with('years',Year::all())->with('states',State::all())->with('stages',Stage::all())->with('teacher',$teacher)->with('cities',City::all());
 }

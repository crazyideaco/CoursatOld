...
class YearController extends Controller
{
    ...
    {
        return view('dashboard.years')->with("years", Year::orderBy('created_at', 'desc')->get())->with('stages', Stage::all());
    }
    ...
    {
        $year = Year::where('id', $id)->first();
        return view('dashboard.edityears')->with("year", $year)->with('stages', Stage::all());
    }

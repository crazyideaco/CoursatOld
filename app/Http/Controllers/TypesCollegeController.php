...
class TypesCollegeController extends Controller
{
  ...
  public function addtypescollege(){
    ...
    $tags = Tag::all();
     ...
     with('sections',$sections)->with('subcolleges',$subcolleges)->with('users',$users)->with('tags',$tags)
...
public function typescolleges(){
    ...
    return view('dashboard.typescolleges')->with('typescolleges',$typescolleges)->with('colleges',College::all())->with('divisions',$divisions)->
   ...
   public function edittypescollege($id){
    ...
    elseif(Auth::user() &&Auth::user()->is_student == 5 && Auth::user()->category_id == 2){
     ...
     with('sections',$sections)->with('subcolleges',$subcolleges)->with('users',$users)->with('universities',University::all())->with('tags',$tags);
 }

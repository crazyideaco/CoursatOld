...
class TypesCollege extends Model
{
    ...
    {
        return $this->belongsToMany(User::class, 'students_typescollege', 'typecollege_id', 'student_id')->withPivot('created_at','updated_at','deleted_at');//->using(Student_Typecollege::class);
    }

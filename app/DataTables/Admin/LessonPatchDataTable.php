...
class LessonPatchDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', 'dashboard.patches.lesson_action')
    ...
    {
        return $model->newQuery()->orderBy("id", "desc")->where([['course_id','=',$this->id],['course_type','=','Lesson']]);
    }
